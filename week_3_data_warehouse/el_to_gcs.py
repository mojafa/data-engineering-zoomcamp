...
# to make task fail sometime just for the sake of the demo
# from random import randint

@task(retries=3)
def ingest_data(dataset_url: str) -> pd.DataFrame:
    # """Ingest data from a URL into a pandas dataframe."""
    # if randint(0, 1) > 0:
...
@flow()
def etl_parent_flow(color: str = "yellow", months: list[int] = [1,2], year: int = 2019):
    for month in months:
