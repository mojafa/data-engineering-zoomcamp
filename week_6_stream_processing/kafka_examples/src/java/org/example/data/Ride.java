...
public class Ride {
    //A Java class Ride with the same structure as the taxi trip files in New York City.
    //The class should have a constructor that takes a String array as an argument.
